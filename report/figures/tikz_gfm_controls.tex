...
\begin{tikzpicture}[x=0.95cm, y=0.72cm, line cap=round, line join=round,
  ...
  \node[lbl] at (6.72,1.98) {$+$};
  \node[lbl] at (6.72,1.22) {$+$};
...
\begin{tikzpicture}[x=0.83cm, y=0.72cm, line cap=round, line join=round,
  ...
  \fill (11.5,4.6) circle (1.3pt);
  \fill (11.5,2.9) circle (1.3pt);
  \draw[wire] (10.4,3.6) -- (11.5,2.9);
  \draw[wire] (11.5,4.6) -- (11.5,4.45);
  \node[lbl, anchor=south] at (10.7,5.0) {VFlag};
  \node[note, anchor=south west] at (11.55,4.7) {0};
  \node[note, anchor=east] at (11.3,2.9) {1};
  % VFlag = 0 path: direct droop through the E limits
  \draw[->,wire] (11.5,4.6) -- (12.55,4.6);
  \satlim{e0}{12.8}{4.6}{$E_{\max}$}
  \node[font=\small, anchor=north, yshift=-1pt] at (e0.south) {$E_{\min}$};
  \draw[->,wire] (e0) -- (13.9,4.6);
  \node[lbl, anchor=west] at (13.95,4.6) {$E_{\mathrm{droop}}$};
  ...
  \node[lbl] at (15.22,2.48) {$+$};
  \node[lbl] at (15.22,1.72) {$+$};
