...
\caption{All-machine response to the bus-14 reference fault: RMS voltage and current, active power, and reactive power at the 230~kV generator buses, on the transmission side of the step-up transformers. The generator-bus active powers oscillate together at about 1~Hz, the inter-machine swing mode, and decay over tens of seconds. The legend lists the monitored buses; bus~14 is isolated by clearing.}
\label{fig:allsync}
\end{figure}
...
\begin{table}[tbp]\centering
\caption{Selected inertia and damping quantities. Damping coefficients use normalized power per normalized frequency.}
\label{tab:dh}
\small
