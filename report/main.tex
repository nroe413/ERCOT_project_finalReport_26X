...
\begin{itemize}
\item \textbf{Limiter-aware stability estimates.} Extend critical-clearing-time analytical model for single and multi-inverter systems to include saturation and determine conditions under which the estimate is conservative.
...
\item \textbf{Large Electronic Loads} Integrate large electronic load profiles and evaluate the impacts to fault-ride through capability of a power system with a high penetration of grid-forming inverters
