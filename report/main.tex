...
\caption{Single-device response to a bolted three-phase-to-ground fault at the point of interconnection (0.001~$\Omega$, five cycles from 3.0~s, self-clearing).}
\label{fig:smibvi}
\end{figure}
...
\caption{PMView inertia estimate of the droop-controlled inverter versus short-circuit ratio. (a)~The estimate referred to the imposed $-1$~Hz/s ramp. (b)~Average rate of change of the inverter's internal droop frequency over the 0.5~s test window.}
\label{fig:hestscr}
\end{figure}
