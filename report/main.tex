...
\begin{table}[tbp]\centering
\caption{Selected inertia and damping quantities, all analytical values from the device parameters (Equations~\eqref{eq:heqdeq} and~\eqref{eq:govpath}). Damping coefficients use normalized power per normalized frequency.}
\label{tab:dh}
\small
