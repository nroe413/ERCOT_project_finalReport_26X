...
\item The \emph{equivalent inertia} of filtered droop arises from the lag in its power measurement and depends on the filter time constant and droop gain \cite{chatterjee2026note}. A longer filter time constant or a smaller droop gain raises this coefficient, and with it the inverter angle's resistance to acceleration, without any physical moment of inertia changing. The electrical energy still comes from the DC source and circuit storage.
