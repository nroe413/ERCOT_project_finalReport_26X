...
GFM_CSV = SJ / "single_machine_infinite_bus_1GFMvalidation" / "SMIB_1GFM_3PG_PSD.csv"
...
SYNC_CSV = SJ / "single_machine_infinite_bus_1syncMachineValidation" / "SMIB_1SYNC_3PG_PSD.csv"
SYNC_CSV_RUN = (SJ / "experiments" / "smib_3PG_GFMvsSync" / "runs"
                / "3PG_5cyc_SCR10_10s" / "SMIB_1SYNC_3PG_PSD.csv")
...
def fig_vi(sy, gf):
    ...
    ax[1].text(5.95, 2.25, "GFM $I_{\\mathrm{max}F}$ = 2.0 pu", color=RED,
