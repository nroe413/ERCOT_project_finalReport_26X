"""Build the Case 2 (Voltage Step Up) PowerPoint deck for the PNNL model.

Inherits theme from slide_templates/meeting_update_042226_r3.pptx and writes
one plot per slide using PNGs produced by _plot_vstepup.py.
"""
import datetime
import glob
import os
...
CASE_TITLE = "Case 2: Voltage Step Up from 1.0 p.u. to 1.05 p.u."
CASE_SUBTITLE = "PNNL REGFM_A1 — PSCAD"
OUT_FNAME_PREFIX = "Case2_VoltageStepUp_PNNL_REGFMA1"
...
def main():
    ...
    if plot_ts is None:
        raise SystemExit("No plot PNGs found in plots/. Run _plot_vstepup.py first.")
