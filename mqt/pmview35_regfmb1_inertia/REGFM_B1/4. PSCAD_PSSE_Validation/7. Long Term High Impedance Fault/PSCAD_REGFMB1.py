...
fault=project.component(1957934564)
fault.parameters(RON="0.1", )

project.parameters(time_duration="5")
project.parameters(time_step="50")

########## Runing Case
print('Long-term High-Impedance fault')

fault_time.parameters(TF="3.0", )
fault_time.parameters(DF="0.5", )
fault.parameters(RON="30", )
...
data_read.to_csv(case_folder + '\\' +   'B1_Flt05s_HI_PSD.csv',index=False)
